/**
 * DEV-Agent Testing Agent (Hermes 集成版)
 * 
 * 测试开发专用 Agent：通过 Hermes 实现真正的 AI 能力
 */
...
function buildSystemPrompt(): string {
  ...
  return `你是一个专业的测试开发 Agent，专注于 pytest、Jest、Playwright、Cypress 测试。
